export default function ApiPage() {
  return (
    <>
      ...
      <p>
        The device database at <code>api.maestroconnect.clearalan.ca</code> exposes public read-only endpoints.
      ...
      <pre><code>GET https://api.maestroconnect.clearalan.ca/templates</code></pre>
      ...
      <pre><code>GET https://api.maestroconnect.clearalan.ca/templates/c0a80101-0006-4000-8000-000000000006</code></pre>
      <p>
      ...
      <pre><code>GET https://api.maestroconnect.clearalan.ca/templates/device-types</code></pre>
      ...
      <pre><code>GET https://api.maestroconnect.clearalan.ca/templates/search-terms</code></pre>
      ...
      <pre><code>GET https://api.maestroconnect.clearalan.ca/contributors</code></pre>
      ...
      <p>
        ...
        <a href="https://devices.maestroconnect.clearalan.ca" target="_blank" rel="noopener noreferrer">devices site</a> UI.
      </p>
