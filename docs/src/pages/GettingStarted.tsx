  ...
  return (
    <>
      ...
      <ol>
        <li>
          <strong>Open</strong>{" "}
          <a href="https://maestroconnect.clearalan.ca/">Maestro Connect</a> in your browser
        </li>
        <li>
      ...
      <p>
        ...
        Maestro Connect follows your OS dark mode setting.
      </p>
      <p>
        The dark mode toggle is also available in the <strong>devices database</strong> (devices.maestroconnect.clearalan.ca)
