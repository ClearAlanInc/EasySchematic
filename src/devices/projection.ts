...
export const templates: DeviceTemplate[] = [
  ...
  {
    id: "c0a80101-0247-4000-8000-000000000728",
    deviceType: "projector",
    category: "projectors",
    label: "Epson Pro L1505U",
    manufacturer: "Epson",
    modelNumber: "Pro L1505U",
    referenceUrl: "https://epson.com/For-Work/Projectors/Large-Venue/Pro-L1505U-Laser-WUXGA-3LCD-Projector-with-4K-Enhancement-&-Standard-Lens/p/V11H792120",
    searchTerms: ["epson", "l1505u", "12000 lumens", "wuxga", "projector", "laser"],
    powerDrawW: 955,
    heightMm: 211,
    widthMm: 587,
    depthMm: 493,
    ...
    ports: [
      ...
      port("HDBaseT In", "hdbaset", "input"),
      port("VGA In (5-BNC)", "vga", "input", "bnc"),
      port("Monitor Out (VGA)", "vga", "output"),
      port("RS-232", "serial", "bidirectional", "db9"),
      port("Ethernet", "ethernet", "bidirectional"),
      port("AC Power", "power", "input"),
    ],
  ...
  {
    id: "c0a80101-0248-4000-8000-000000000729",
    deviceType: "projector",
    category: "projectors",
    label: "Epson EB-PU2216B",
    manufacturer: "Epson",
    modelNumber: "EB-PU2216B",
    referenceUrl: "https://epson.com/For-Work/Projectors/Large-Venue/EB-PU2216B-16,000-Lumen-3LCD-Large-Venue-Laser-Projector-with-4K-Enhancement/p/V11HA67820",
    searchTerms: ["epson", "pu2216b", "16000 lumens", "wuxga", "projector", "laser", "black"],
    powerDrawW: 1118,
    heightMm: 185,
    widthMm: 586,
    depthMm: 492,
