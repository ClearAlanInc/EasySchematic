...
export const templates: DeviceTemplate[] = [
  ...
  },
  {
    ...
    searchTerms: ["birddog", "ptz", "p200", "ndi", "1080p"],
    poeDrawW: 19.7, // PoE+ (802.3at); also 12V DC capable
    heightMm: 195,
    widthMm: 164,
    depthMm: 214,
    weightKg: 2,
    ports: [
      port("NDI / Ethernet (PoE+)", "ethernet", "bidirectional"),
      port("3G-SDI Out", "sdi", "output"),
      port("HDMI Out", "hdmi", "output"),
      port("3.5mm Audio In", "analog-audio", "input", "trs-eighth"),
      port("3.5mm Audio Out", "analog-audio", "output", "trs-eighth"),
      port("Serial Control 1 (RJ45)", "rs422", "bidirectional", "rj45"),
      port("Serial Control 2 (RJ45)", "rs422", "bidirectional", "rj45"),
      port("DC Power", "power", "input", "barrel"),
    ],
  },
  {
    ...
    searchTerms: ["birddog", "ptz", "p120", "ndi", "1080p", "20x"],
    poeDrawW: 15.2, // PoE+ (802.3at); also 12V DC capable
    heightMm: 171,
    widthMm: 152,
    depthMm: 145,
    weightKg: 1,
    ports: [
      ...
      port("SDI Out", "sdi", "output"),
      port("HDMI Out", "hdmi", "output"),
      port("USB 2.0 (UVC)", "usb", "output"),
      port("3.5mm Audio In", "analog-audio", "input", "trs-eighth"),
      port("3.5mm Audio Out", "analog-audio", "output", "trs-eighth"),
      port("Serial Control (RJ45)", "rs422", "bidirectional", "rj45"),
      port("DC Power", "power", "input", "barrel"),
    ],
  },
