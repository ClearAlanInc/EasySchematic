...
export const templates: DeviceTemplate[] = [
  ...
  // ── Crestron Cameo wireless in-wall load controls (infiNET EX) ──
  {
    id: "c0a80101-031f-4000-8000-000000000753",
    deviceType: "dimmer",
    label: "Crestron CLW-DIMUEX-P",
    manufacturer: "Crestron",
    modelNumber: "CLW-DIMUEX-P",
    referenceUrl: "https://www.crestron.com/Products/Catalog/Lighting-and-Environmental/Cameo/Dimmers/CLW-DIMUEX-P-A-S",
    searchTerms: ["crestron", "cameo", "dimmer", "in-wall", "wireless", "infinet", "keypad", "universal", "phase"],
    voltage: "120V",
    heightMm: 105,
    widthMm: 45,
    depthMm: 45,
    weightKg: 0.14,
    rackForm: "shelf-only", // 1-gang US electrical box
    ports: [
      port("Line (120V)", "power", "input", "terminal-block"),
      port("Load (Dimmed, 600W)", "power", "output", "terminal-block"),
      port("Remote (Traveler)", "control-voltage", "bidirectional", "terminal-block"),
      port("infiNET EX", "rf", "bidirectional", "wireless"),
    ],
  },
  {
    id: "c0a80101-0320-4000-8000-000000000754",
    deviceType: "dimmer",
    label: "Crestron CLW-DIMSWEX-P",
    manufacturer: "Crestron",
    modelNumber: "CLW-DIMSWEX-P",
    referenceUrl: "https://www.crestron.com/Products/Catalog/Lighting-and-Environmental/Cameo/Dimmer-Switch-Combo/CLW-DIMSWEX-P-W-S",
    searchTerms: ["crestron", "cameo", "dimmer", "switch", "combo", "in-wall", "wireless", "infinet", "fan"],
    voltage: "120V",
    heightMm: 105,
    widthMm: 45,
    depthMm: 45,
    ...
    ports: [
      port("Line (120V)", "power", "input", "terminal-block"),
      port("Dim Load (500W)", "power", "output", "terminal-block"),
      port("Switch Load (1A)", "power", "output", "terminal-block"),
      port("infiNET EX", "rf", "bidirectional", "wireless"),
    ],
  },
  {
    id: "c0a80101-0321-4000-8000-000000000755",
    deviceType: "dimmer",
    label: "Crestron CLW-SWEX-P",
    manufacturer: "Crestron",
    modelNumber: "CLW-SWEX-P",
    referenceUrl: "https://www.crestron.com/Products/Catalog/Lighting-and-Environmental/Cameo/Switches/CLW-SWEX-P-W-S",
    searchTerms: ["crestron", "cameo", "switch", "in-wall", "wireless", "infinet", "keypad"],
    voltage: "120V",
    heightMm: 105,
    widthMm: 45,
    depthMm: 45,
    ...
    ports: [
      port("Line (120V)", "power", "input", "terminal-block"),
      port("Load (1000W)", "power", "output", "terminal-block"),
      port("Remote (Traveler)", "control-voltage", "bidirectional", "terminal-block"),
      port("infiNET EX", "rf", "bidirectional", "wireless"),
    ],
  },
